...
export class DropzoneDirective {
    ...
    @Input('thumbnails') thumbnails: DropzoneThumbnail[] = [];
    ...
    ngOnInit() {
        ...
        if (!this.configDiff) {
            ...
            this.thumbnails.forEach((thumbnail) => {
                this.dropzone.emit('addedfile', thumbnail);
                this.dropzone.emit('thumbnail', thumbnail, thumbnail.url);
                this.dropzone.createThumbnailFromUrl(thumbnail, thumbnail.url, null, 'anonymous');
                this.dropzone.emit('complete', thumbnail);
